	...
	<view class="mine_box">
			...
			<view class="mine_info">
				<view class="userInfo_box" @click="handleLogin">
					...
					<view class="user_info">
						...
						<u-button class="syncBtn" :ripple="true" size="mini" shape="circle" @click="syncZL">同步微信资料</u-button>
					</view>
				</view>
		...
		<view class="cellListBox">
			<u-cell-group class="cellList">
				...
				<u-cell-item icon="server-fill" ><button class="service" open-type='contact' hover-class="u-cell-hover">联系客服</button></u-cell-item>
			</u-cell-group>
		</view>
